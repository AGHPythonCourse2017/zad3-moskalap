sentences = {
    ...
    'Ariana Grande dies at manchester terrorist attack': {'subject': 'Ariana Grande', 'verb': 'dies',
                                                          'predicate': 'dies at manchester terrorist attack',
                                                          'negated': False},
    "Ariana Grande does not die at manchester terrorist attack": {'subject': 'Ariana Grande', 'verb': 'die',
                                                                  'predicate': 'die at manchester terrorist attack',
                                                                  'negated': 3},
    'World War II was in 1940': {'subject': 'World War II', 'verb': 'was', 'predicate': 'was in 1940',
                                 'negated': False},
    'World War II was not in 1940': {'subject': 'World War II', 'verb': 'was', 'predicate': 'was not in 1940',
                                     'negated': 4},
    ...
    'Tram is the fastest vehicle': {'subject': 'Tram', 'verb': 'is', 'predicate': 'is the fastest vehicle',
                                    'negated': False},
    'The sun is a star': {'subject': 'sun', 'verb': 'is', 'predicate': 'is a star', 'negated': False},
    'Yogurt is a dairy product': {'subject': 'Yogurt', 'verb': 'is', 'predicate': 'is a dairy product',
                                  'negated': False},
    'The Russia, which is the largest country, has not the largest military in the world': {'subject': 'Russia',
                                                                                            'verb': 'has',
                                                                                            'predicate': 'has not the largest military in the world',
                                                                                            'negated': 8},
    ...
    'Cats are better than dogs': {'subject': 'Cats', 'verb': 'are', 'predicate': 'are better than dogs',
                                  'negated': False},
...
for k in sentences.keys():
    ...
    print(k+ " ->" +sentence.get_opposite().sentence)